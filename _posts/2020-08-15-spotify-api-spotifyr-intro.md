...
Overall, these strong measures show that even though elán vital has a consistent “mood” throughout the playlist, there are still specific groupings within it. In this analysis, I am only scratching the surface of this data's potential. In later posts, I will analyze the lyrics and themes present in albums, combine lyrical themes with each song's audio features, further investigate my listening habits, and more. 
